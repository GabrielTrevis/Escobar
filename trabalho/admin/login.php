<?php
session_start(); // Inicia a sessão PHP para permitir o uso de variáveis de sessão

// Verifica se o usuário já está logado
// Se estiver, redireciona diretamente para o painel administrativo
if (isset($_SESSION['logado']) && $_SESSION['logado'] === true) {
    header("Location: index.php");
    exit; // Encerra a execução do script após o redirecionamento
}

// Tratamento de mensagens de erro que podem vir via parâmetro GET
$erro = '';
if (isset($_GET['erro'])) {
    switch ($_GET['erro']) {
        case 'credenciais':
...
<head>
    ...
    <style>
        ...
        body {
            ...
            height: 100vh;
            display: flex; /* Centraliza o conteúdo verticalmente e horizontalmente */
            align-items: center;
    ...
    <div class="login-container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- Formulário de login que envia os dados para processa_login.php -->
